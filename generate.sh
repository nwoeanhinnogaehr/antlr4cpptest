...
ROOT=~/school/cmput/415
CLASSPATH=$ROOT/antlr4/tool/target/classes:$ROOT/antlr4/runtime/Java/target/classes:$ROOT/antlr3/runtime/Java/target/classes:/usr/local/lib/ST-4.0.8.jar

java -cp $CLASSPATH org.antlr.v4.Tool -Dlanguage=Cpp -listener -visitor -o generated/ -package antlrcpptest src/*.g4
